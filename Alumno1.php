...
class Alumno extends Usuario{
    ...
    public function readAlumno(){
        $sql01 = "SELECT * FROM usuario WHERE status = 1 AND nivel=3 ORDER BY ApellidoPaterno ASC";
        ...
        while ($field = mysql_fetch_array($result01)) {
            ...
            $sql03="SELECT * FROM alumnos_grupo WHERE id_alumno = $field[Id]";
            ...
            if($existe == 0) {
                ...
                echo "<a href=TestGrupo.php?accion=2&alumno_id=$field[Id]>Eliminar</a> </td></tr>";
            }
        }
